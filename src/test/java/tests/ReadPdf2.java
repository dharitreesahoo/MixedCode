...
public class ReadPdf2 {
	public static void main(String args[]) throws IOException {
		try {
			...
			PrintWriter csvFile = new PrintWriter("d:/data.csv");// this is the
																// name of csv
																// excel file
																// where the pdf
																// data will
			...
			PDDocument document = PDDocument.load(new File("C:/Users/home/Downloads/Help Card - NPTR 1052 - Org movement.pdf"));// here
																			// file2.pdf
																			// is
																			// the
																			// name
			...
			if (!document.isEncrypted()) {
				...
				scnLine = new Scanner(str);// scanner to read lines from pdf
											// file...
				...
				while (scnLine.hasNextLine()) {
					...
					Scanner scnWord = new Scanner(line); // scanner to read
															// words from
															// lines....
